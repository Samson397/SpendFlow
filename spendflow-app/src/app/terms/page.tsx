    ...
    <div className="max-w-4xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
      <div className="text-center mb-12">
        <div className="flex justify-center mb-4">
          <div className="p-3 bg-amber-100 dark:bg-amber-900/30 rounded-full">
            <Gavel className="h-8 w-8 text-amber-600 dark:text-amber-400" />
          </div>
        </div>
      ...
      <div className="prose dark:prose-invert max-w-none">
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">2. Definitions</h2>
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">3. Account Registration</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">4. User Responsibilities</h2>
            <p className="text-slate-700 dark:text-slate-300">
              You agree not to:
            </p>
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">5. Payment Terms</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">6. Data Handling</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">7. Third-Party Services</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">8. Intellectual Property</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">6. Termination</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">7. Limitation of Liability</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">8. Governing Law</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">9. Dispute Resolution</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">10. Force Majeure</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">11. Severability</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">12. Entire Agreement</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">13. Changes to Terms</h2>
            <p className="text-slate-700 dark:text-slate-300">
          ...
          <section>
            <h2 className="text-2xl font-serif font-semibold text-slate-900 dark:text-white mb-4">14. Contact Us</h2>
            <p className="text-slate-700 dark:text-slate-300">
